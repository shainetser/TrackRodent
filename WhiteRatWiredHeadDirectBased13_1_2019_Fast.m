function  [RatLocationCenterOfBody,TimesOfStimuliExploration,TimesInDifferentCompartments,firstFrameInTheAnalysis,LastAnalyzedFrame]=...
  WhiteRatWiredHeadDirectBased13_1_2019_Fast(filenameBehavioral,HandlesForGUIControls,StartingFrameForAnalysis,EndingFrameForAnalysis,ExcludedAreasList,CompartmentsPositionsList,StimuliPositionsList,SaveMovie,LowThresholdValue,HighThresholdValue,MovieNum);
...
global StopAnalysis
  ...
  for k=StartingFrameForAnalysis:EndingFrameForAnalysis
     ...
     try
        ...
        BoundariesDistanceHighFromLowHighThreshold=[];
