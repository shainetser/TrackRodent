...
%%%%  1) The mice algorithms are for black mice over a white background and
%%%%  for white rats on a black background.

%%%%  2)If you cann't save figures of the results this might be the broblem: 
...
%%%% 3)For working with the Head directed algorithms you need the
