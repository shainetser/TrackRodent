function  [RatLocationCenterOfBody,TimesOfStimuliExploration,TimesInDifferentCompartments,firstFrameInTheAnalysis,LastAnalyzedFrame]=...
  WhiteRatWiredBodyBased15_5_18(filenameBehavioral,HandlesForGUIControls,StartingFrameForAnalysis,EndingFrameForAnalysis,ExcludedAreasList,CompartmentsPositionsList,StimuliPositionsList,SaveMovie,LowThresholdValue, MovieNum);
...
global StopAnalysis
  ...
  for k=StartingFrameForAnalysis:EndingFrameForAnalysis
     ...
     se = strel('disk',11);
     Clean_cdataBW=imclose(Clean_cdataBW,se);
     se = strel('disk',20);
     Clean_cdataBW=imerode(Clean_cdataBW,se);
     Clean_cdataBW=imdilate(Clean_cdataBW,se);
