function  [MouseLocationCenterOfBody,TimesOfStimuliExploration,TimesInDifferentCompartments,firstFrameInTheAnalysis,LastFrameAnalyzed]=WhiteMouseBodyBased11_6_17(filenameBehavioral,HandlesForGUIControls,StartingFrameForAnalysis,EndingFrameForAnalysis,ExcludedAreasList,CompartmentsPositionsList,StimuliPositionsList,SaveMovie,LowThresholdValue, MovieNum);
...
global StopAnalysis
  ...
  for k=StartingFrameForAnalysis:EndingFrameForAnalysis
    ...
    elseif ~isempty(MouseBoundary)
       plot(mean(MouseBoundary(:,2)),mean(MouseBoundary(:,1)),'kX'); 
