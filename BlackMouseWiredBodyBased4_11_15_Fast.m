...
global StopAnalysis
  ...
  for k=StartingFrameForAnalysis:EndingFrameForAnalysis
     ...
     try
        ...
        BoundariesSizes(find(BoundariesSizes==max(BoundariesSizes)))=0;
        MouseBoundary2=BoundariesWB{find(BoundariesSizes==max(BoundariesSizes)),1};
     catch
