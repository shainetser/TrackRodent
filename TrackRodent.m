...
% Last Modified by GUIDE v2.5 28-Jan-2020 18:51:50
...
global FrameRateForAnalysisAllFiles
...
global TimesOfMiceInteractionDistantInteraction
global TimesOfMiceInteractionTightInteraction
...
oldpath = path;
path(oldpath,'Ellipse_fitting');
oldpath = path;
path(oldpath,'export_fig');
oldpath = path;
path(oldpath,'Fitting quadratic curves and surfaces');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
try
   ...
   FrameRateForAnalysisAllFiles(CurrentFileAnalyzed)=str2num(get(HandlesForGUIControls.FrameRateForAnalysisEdit,'String'));
   ...
   if iscell(filenameBehavioral) 
      FrameRateForAnalysisAllFiles(1:(length(filenameBehavioral)-1))=30;  
   ...
   MaxFrameNum=floor(Film.Duration*Film.FrameRate)-1;
...
try
   ...
   set(HandlesForGUIControls.FrameRateForAnalysisEdit,'string',num2str(FrameRateForAnalysisAllFiles(CurrentFileAnalyzed)));
...
if AnimalType==0 %%%%% for mouse
   ...
   for i=1:size(BoundariesWB,1) 
      BoundaryToPlot=BoundariesWB{i,1}; 
      plot(BoundaryToPlot(:,2),BoundaryToPlot(:,1),'-r','LineWidth',2) 
   end
else   %%%%% for rat
   Film = VideoReader(FilmName);
   %%%%% open the image, convert it to black and white and clean it from noise      
...
%    Clean_cdataBW=imerode(Clean_cdataBW,se);
%    Clean_cdataBW=imdilate(Clean_cdataBW,se);
   Clean_cdataBW = fibermetric(double(Clean_cdataBW),30);
   TempHighThreshold=HighThresholdValueAllFiles(CurrentFileAnalyzed)*3;
   if TempHighThreshold>1
      TempHighThreshold=1;
   end
   Clean_cdataBW=im2bw(Clean_cdataBW,TempHighThreshold);
   %%%%% look for boundaries of the rat
   BoundariesWB = bwboundaries(Clean_cdataBW);
   axes(HandlesForGUIControls.axes1);
   hold on;
...
for MovieNum=1:(size(filenameBehavioral,2)-1)
   ...
   TimesOfMiceInteractionDistantInteraction=[];
   TimesOfMiceInteractionTightInteraction=[];
   ...
   try
      FrameRateForAnalysis=FrameRateForAnalysisAllFiles(MovieNum);
   catch
      %%% Do nothing    
   end
   ...
   switch SelectedAlgorithm
       case 'BlackMouseBodyBased23_7_14'
          [MouseLocationCenterOfBody,TimesOfStimuliExploration,TimesInDifferentCompartments,firstFrameInTheAnalysis,LastFrameAnalyzed]=BlackMouseBodyBased23_7_14(filenameBehavioralForAnalysis,HandlesForGUIControls,StartingFrameForAnalysisNum,EndingFrameForAnalysisNum,ExcludedAreasList,CompartmentsPositionsList,StimuliPositionsList,SaveMovie,LowThresholdValue,MovieNum);
          ...
          if SaveResultsWhenAnalysisFinished==1
             ...
             'LowThresholdValue', 'HighThresholdValue','FrameRateForAnalysis')
             set(HandlesForGUIControls.StatusText,'string','Analysis parameters and data were saved'); 
          end
       case 'BlackMouseBodyBased23_7_14_Fast'
          [MouseLocationCenterOfBody,TimesOfStimuliExploration,TimesInDifferentCompartments,firstFrameInTheAnalysis,LastFrameAnalyzed]=BlackMouseBodyBased23_7_14_Fast(filenameBehavioralForAnalysis,HandlesForGUIControls,StartingFrameForAnalysisNum,EndingFrameForAnalysisNum,ExcludedAreasList,CompartmentsPositionsList,StimuliPositionsList,SaveMovie,LowThresholdValue,MovieNum);
          set(HandlesForGUIControls.StatusText,'string','Finished analyzing');
          if SaveResultsWhenAnalysisFinished==1
             filenameOfSettings=[filenameBehavioralForAnalysis(1:end-4) '_video_data_results' num2str(MovieNum) '.mat'];
             save(filenameOfSettings,'filenameBehavioralForAnalysis','StartingFrameForAnalysisNum','EndingFrameForAnalysisNum','LastFrameAnalyzed','ExcludedAreasList','CompartmentsPositionsList','StimuliPositionsList',...
       ...
       case 'BlackMouseHeadDirectionalityBased10_3_2016'
          [MouseLocationCenterOfBody,TimesOfStimuliExploration,TimesInDifferentCompartments,firstFrameInTheAnalysis,LastFrameAnalyzed]=BlackMouseHeadDirectionalityBased10_3_2016(filenameBehavioralForAnalysis,HandlesForGUIControls,StartingFrameForAnalysisNum,EndingFrameForAnalysisNum,ExcludedAreasList,CompartmentsPositionsList,StimuliPositionsList,SaveMovie,LowThresholdValue,HighThresholdValue,MovieNum);
          set(HandlesForGUIControls.StatusText,'string','Finished analyzing');
          if SaveResultsWhenAnalysisFinished==1
             filenameOfSettings=[filenameBehavioralForAnalysis(1:end-4) '_video_data_results' num2str(MovieNum) '.mat'];
             save(filenameOfSettings,'filenameBehavioralForAnalysis','StartingFrameForAnalysisNum','EndingFrameForAnalysisNum','LastFrameAnalyzed','ExcludedAreasList','CompartmentsPositionsList','StimuliPositionsList',...
       ...
       case 'BlackMouseHeadDirectionalityBased10_3_2016_Fast'
          [MouseLocationCenterOfBody,TimesOfStimuliExploration,TimesInDifferentCompartments,firstFrameInTheAnalysis,LastFrameAnalyzed]=BlackMouseHeadDirectionalityBased10_3_2016_Fast(filenameBehavioralForAnalysis,HandlesForGUIControls,StartingFrameForAnalysisNum,EndingFrameForAnalysisNum,ExcludedAreasList,CompartmentsPositionsList,StimuliPositionsList,SaveMovie,LowThresholdValue,HighThresholdValue,MovieNum);
          set(HandlesForGUIControls.StatusText,'string','Finished analyzing');
          if SaveResultsWhenAnalysisFinished==1
             filenameOfSettings=[filenameBehavioralForAnalysis(1:end-4) '_video_data_results' num2str(MovieNum) '.mat'];
             save(filenameOfSettings,'filenameBehavioralForAnalysis','StartingFrameForAnalysisNum','EndingFrameForAnalysisNum','LastFrameAnalyzed','ExcludedAreasList','CompartmentsPositionsList','StimuliPositionsList',...
       ...
       case 'BlackMice_TwoMiceFreeInteraction3_1_16'
          [TimesOfTwoMiceInteraction, MouseLocationCenterOfBody1, MouseLocationCenterOfBody2, firstFrameInTheAnalysis,LastFrameAnalyzed]=BlackMice_TwoMiceFreeInteraction3_1_16(filenameBehavioralForAnalysis,HandlesForGUIControls,StartingFrameForAnalysisNum,EndingFrameForAnalysisNum,ExcludedAreasList,SaveMovie,LowThresholdValue,MovieNum);
          set(HandlesForGUIControls.StatusText,'string','Finished analyzing');
          if SaveResultsWhenAnalysisFinished==1
             filenameOfSettings=[filenameBehavioralForAnalysis(1:end-4) '_video_data_results' num2str(MovieNum) '.mat'];
             save(filenameOfSettings,'filenameBehavioralForAnalysis','StartingFrameForAnalysisNum','EndingFrameForAnalysisNum','LastFrameAnalyzed','ExcludedAreasList','CompartmentsPositionsList','StimuliPositionsList',...
       ...
       case 'BlackMice_TwoMiceFreeInteraction3_1_16_Fast'
          [TimesOfTwoMiceInteraction, MouseLocationCenterOfBody1, MouseLocationCenterOfBody2, firstFrameInTheAnalysis,LastFrameAnalyzed]=BlackMice_TwoMiceFreeInteraction3_1_16_Fast(filenameBehavioralForAnalysis,HandlesForGUIControls,StartingFrameForAnalysisNum,EndingFrameForAnalysisNum,ExcludedAreasList,SaveMovie,LowThresholdValue,MovieNum);
          set(HandlesForGUIControls.StatusText,'string','Finished analyzing');
          if SaveResultsWhenAnalysisFinished==1
             filenameOfSettings=[filenameBehavioralForAnalysis(1:end-4) '_video_data_results' num2str(MovieNum) '.mat'];
             save(filenameOfSettings,'filenameBehavioralForAnalysis','StartingFrameForAnalysisNum','EndingFrameForAnalysisNum','LastFrameAnalyzed','ExcludedAreasList','CompartmentsPositionsList','StimuliPositionsList',...
       ...
       case 'WhiteRatBodyBased15_7_15'
          [MouseLocationCenterOfBody,TimesOfStimuliExploration,TimesInDifferentCompartments,firstFrameInTheAnalysis,LastFrameAnalyzed]=WhiteRatBodyBased15_7_15(filenameBehavioralForAnalysis,HandlesForGUIControls,StartingFrameForAnalysisNum,EndingFrameForAnalysisNum,ExcludedAreasList,CompartmentsPositionsList,StimuliPositionsList,SaveMovie,LowThresholdValue,MovieNum);
          set(HandlesForGUIControls.StatusText,'string','Finished analyzing');
          if SaveResultsWhenAnalysisFinished==1
             filenameOfSettings=[filenameBehavioralForAnalysis(1:end-4) '_video_data_results' num2str(MovieNum) '.mat'];
             save(filenameOfSettings,'filenameBehavioralForAnalysis','StartingFrameForAnalysisNum','EndingFrameForAnalysisNum','LastFrameAnalyzed','ExcludedAreasList','CompartmentsPositionsList','StimuliPositionsList',...
       ...
       case 'WhiteRatBodyBased15_7_15_Fast'
          [MouseLocationCenterOfBody,TimesOfStimuliExploration,TimesInDifferentCompartments,firstFrameInTheAnalysis,LastFrameAnalyzed]=WhiteRatBodyBased15_7_15_Fast(filenameBehavioralForAnalysis,HandlesForGUIControls,StartingFrameForAnalysisNum,EndingFrameForAnalysisNum,ExcludedAreasList,CompartmentsPositionsList,StimuliPositionsList,SaveMovie,LowThresholdValue,MovieNum);
          set(HandlesForGUIControls.StatusText,'string','Finished analyzing');
          if SaveResultsWhenAnalysisFinished==1
             filenameOfSettings=[filenameBehavioralForAnalysis(1:end-4) '_video_data_results' num2str(MovieNum) '.mat'];
             save(filenameOfSettings,'filenameBehavioralForAnalysis','StartingFrameForAnalysisNum','EndingFrameForAnalysisNum','LastFrameAnalyzed','ExcludedAreasList','CompartmentsPositionsList','StimuliPositionsList',...
       ...
       case 'BlackMouseWiredBodyBased4_11_15'
          [MouseLocationCenterOfBody,TimesOfStimuliExploration,TimesInDifferentCompartments,firstFrameInTheAnalysis,LastFrameAnalyzed]=BlackMouseWiredBodyBased4_11_15(filenameBehavioralForAnalysis,HandlesForGUIControls,StartingFrameForAnalysisNum,EndingFrameForAnalysisNum,ExcludedAreasList,CompartmentsPositionsList,StimuliPositionsList,SaveMovie,LowThresholdValue,MovieNum);
          set(HandlesForGUIControls.StatusText,'string','Finished analyzing');
          if SaveResultsWhenAnalysisFinished==1
             filenameOfSettings=[filenameBehavioralForAnalysis(1:end-4) '_video_data_results' num2str(MovieNum) '.mat'];
             save(filenameOfSettings,'filenameBehavioralForAnalysis','StartingFrameForAnalysisNum','EndingFrameForAnalysisNum','LastFrameAnalyzed','ExcludedAreasList','CompartmentsPositionsList','StimuliPositionsList',...
       ...
       case 'BlackMouseWiredBodyBased4_11_15_Fast'
          [MouseLocationCenterOfBody,TimesOfStimuliExploration,TimesInDifferentCompartments,firstFrameInTheAnalysis,LastFrameAnalyzed]=BlackMouseWiredBodyBased4_11_15_Fast(filenameBehavioralForAnalysis,HandlesForGUIControls,StartingFrameForAnalysisNum,EndingFrameForAnalysisNum,ExcludedAreasList,CompartmentsPositionsList,StimuliPositionsList,SaveMovie,LowThresholdValue,MovieNum);
          set(HandlesForGUIControls.StatusText,'string','Finished analyzing');
          if SaveResultsWhenAnalysisFinished==1
             filenameOfSettings=[filenameBehavioralForAnalysis(1:end-4) '_video_data_results' num2str(MovieNum) '.mat'];
             save(filenameOfSettings,'filenameBehavioralForAnalysis','StartingFrameForAnalysisNum','EndingFrameForAnalysisNum','LastFrameAnalyzed','ExcludedAreasList','CompartmentsPositionsList','StimuliPositionsList',...
       ...
       case 'WhiteMouseBodyBased11_6_17'
          [MouseLocationCenterOfBody,TimesOfStimuliExploration,TimesInDifferentCompartments,firstFrameInTheAnalysis,LastFrameAnalyzed]=WhiteMouseBodyBased11_6_17(filenameBehavioralForAnalysis,HandlesForGUIControls,StartingFrameForAnalysisNum,EndingFrameForAnalysisNum,ExcludedAreasList,CompartmentsPositionsList,StimuliPositionsList,SaveMovie,LowThresholdValue,MovieNum);
          set(HandlesForGUIControls.StatusText,'string','Finished analyzing');
          if SaveResultsWhenAnalysisFinished==1
             filenameOfSettings=[filenameBehavioralForAnalysis(1:end-4) '_video_data_results' num2str(MovieNum) '.mat'];
             save(filenameOfSettings,'filenameBehavioralForAnalysis','StartingFrameForAnalysisNum','EndingFrameForAnalysisNum','LastFrameAnalyzed','ExcludedAreasList','CompartmentsPositionsList','StimuliPositionsList',...
       ...
       case 'WhiteMouseBodyBased11_6_17_Fast'
          [MouseLocationCenterOfBody,TimesOfStimuliExploration,TimesInDifferentCompartments,firstFrameInTheAnalysis,LastFrameAnalyzed]=WhiteMouseBodyBased11_6_17_Fast(filenameBehavioralForAnalysis,HandlesForGUIControls,StartingFrameForAnalysisNum,EndingFrameForAnalysisNum,ExcludedAreasList,CompartmentsPositionsList,StimuliPositionsList,SaveMovie,LowThresholdValue,MovieNum);
          set(HandlesForGUIControls.StatusText,'string','Finished analyzing');
          if SaveResultsWhenAnalysisFinished==1
             filenameOfSettings=[filenameBehavioralForAnalysis(1:end-4) '_video_data_results' num2str(MovieNum) '.mat'];
             save(filenameOfSettings,'filenameBehavioralForAnalysis','StartingFrameForAnalysisNum','EndingFrameForAnalysisNum','LastFrameAnalyzed','ExcludedAreasList','CompartmentsPositionsList','StimuliPositionsList',...
       ...
       case 'WhiteMouseWiredBodyBased3_7_19'
          [MouseLocationCenterOfBody,TimesOfStimuliExploration,TimesInDifferentCompartments,firstFrameInTheAnalysis,LastFrameAnalyzed]=WhiteMouseWiredBodyBased3_7_19(filenameBehavioralForAnalysis,HandlesForGUIControls,StartingFrameForAnalysisNum,EndingFrameForAnalysisNum,ExcludedAreasList,CompartmentsPositionsList,StimuliPositionsList,SaveMovie,LowThresholdValue,MovieNum);
          set(HandlesForGUIControls.StatusText,'string','Finished analyzing');
          if SaveResultsWhenAnalysisFinished==1
             filenameOfSettings=[filenameBehavioralForAnalysis(1:end-4) '_video_data_results' num2str(MovieNum) '.mat'];
             save(filenameOfSettings,'filenameBehavioralForAnalysis','StartingFrameForAnalysisNum','EndingFrameForAnalysisNum','LastFrameAnalyzed','ExcludedAreasList','CompartmentsPositionsList','StimuliPositionsList',...
       ...
       case 'WhiteMouseWiredBodyBased3_7_19_Fast'
          [MouseLocationCenterOfBody,TimesOfStimuliExploration,TimesInDifferentCompartments,firstFrameInTheAnalysis,LastFrameAnalyzed]=WhiteMouseWiredBodyBased3_7_19_Fast(filenameBehavioralForAnalysis,HandlesForGUIControls,StartingFrameForAnalysisNum,EndingFrameForAnalysisNum,ExcludedAreasList,CompartmentsPositionsList,StimuliPositionsList,SaveMovie,LowThresholdValue,MovieNum);
          set(HandlesForGUIControls.StatusText,'string','Finished analyzing');
          if SaveResultsWhenAnalysisFinished==1
             filenameOfSettings=[filenameBehavioralForAnalysis(1:end-4) '_video_data_results' num2str(MovieNum) '.mat'];
             save(filenameOfSettings,'filenameBehavioralForAnalysis','StartingFrameForAnalysisNum','EndingFrameForAnalysisNum','LastFrameAnalyzed','ExcludedAreasList','CompartmentsPositionsList','StimuliPositionsList',...
       ...
       case 'WhiteRats_TwoRatsFreeInteraction07_5_18'
          [TimesOfTwoMiceInteraction, TimesOfMiceInteractionDistantInteraction, TimesOfMiceInteractionTightInteraction, MouseLocationCenterOfBody1, MouseLocationCenterOfBody2, firstFrameInTheAnalysis,LastFrameAnalyzed]=...
          WhiteRats_TwoRatsFreeInteraction07_5_18(filenameBehavioralForAnalysis,HandlesForGUIControls,StartingFrameForAnalysisNum,EndingFrameForAnalysisNum,ExcludedAreasList,SaveMovie,LowThresholdValue,MovieNum);
          set(HandlesForGUIControls.StatusText,'string','Finished analyzing');
          if SaveResultsWhenAnalysisFinished==1
             filenameOfSettings=[filenameBehavioralForAnalysis(1:end-4) '_video_data_results' num2str(MovieNum) '.mat'];
             save(filenameOfSettings,'filenameBehavioralForAnalysis','StartingFrameForAnalysisNum','EndingFrameForAnalysisNum','LastFrameAnalyzed','ExcludedAreasList','CompartmentsPositionsList','StimuliPositionsList',...
             'MouseLocationCenterOfBody','MouseLocationCenterOfBody1','MouseLocationCenterOfBody2','TimesOfStimuliExploration','TimesInDifferentCompartments','firstFrameInTheAnalysis',...
             'TimesOfMiceInteractionDistantInteraction', 'TimesOfMiceInteractionTightInteraction', 'TimesOfTwoMiceInteraction',...
             'LowThresholdValue', 'HighThresholdValue','FrameRateForAnalysis')
             set(HandlesForGUIControls.StatusText,'string','Analysis parameters and data were saved'); 
          end
       case 'WhiteRats_TwoRatsFreeInteraction07_5_18_Fast'
          [TimesOfTwoMiceInteraction, TimesOfMiceInteractionDistantInteraction, TimesOfMiceInteractionTightInteraction, MouseLocationCenterOfBody1, MouseLocationCenterOfBody2, firstFrameInTheAnalysis,LastFrameAnalyzed]=...
          WhiteRats_TwoRatsFreeInteraction07_5_18_Fast(filenameBehavioralForAnalysis,HandlesForGUIControls,StartingFrameForAnalysisNum,EndingFrameForAnalysisNum,ExcludedAreasList,SaveMovie,LowThresholdValue,MovieNum);
          set(HandlesForGUIControls.StatusText,'string','Finished analyzing');
          if SaveResultsWhenAnalysisFinished==1
             filenameOfSettings=[filenameBehavioralForAnalysis(1:end-4) '_video_data_results' num2str(MovieNum) '.mat'];
             save(filenameOfSettings,'filenameBehavioralForAnalysis','StartingFrameForAnalysisNum','EndingFrameForAnalysisNum','LastFrameAnalyzed','ExcludedAreasList','CompartmentsPositionsList','StimuliPositionsList',...
       ...
       case 'WhiteRatWiredBodyBased15_5_18'
         [MouseLocationCenterOfBody,TimesOfStimuliExploration,TimesInDifferentCompartments,firstFrameInTheAnalysis,LastFrameAnalyzed]=...
         WhiteRatWiredBodyBased15_5_18(filenameBehavioralForAnalysis,HandlesForGUIControls,StartingFrameForAnalysisNum,EndingFrameForAnalysisNum,ExcludedAreasList,CompartmentsPositionsList,StimuliPositionsList,SaveMovie,LowThresholdValue,MovieNum);
         set(HandlesForGUIControls.StatusText,'string','Finished analyzing');
         if SaveResultsWhenAnalysisFinished==1
            filenameOfSettings=[filenameBehavioralForAnalysis(1:end-4) '_video_data_results' num2str(MovieNum) '.mat'];
            save(filenameOfSettings,'filenameBehavioralForAnalysis','StartingFrameForAnalysisNum','EndingFrameForAnalysisNum','LastFrameAnalyzed','ExcludedAreasList','CompartmentsPositionsList','StimuliPositionsList',...
       ...
       case 'WhiteRatWiredHeadDirectBased13_1_2019'
          [MouseLocationCenterOfBody,TimesOfStimuliExploration,TimesInDifferentCompartments,firstFrameInTheAnalysis,LastFrameAnalyzed]=...
          WhiteRatWiredHeadDirectBased13_1_2019(filenameBehavioralForAnalysis,HandlesForGUIControls,StartingFrameForAnalysisNum,EndingFrameForAnalysisNum,ExcludedAreasList,CompartmentsPositionsList,StimuliPositionsList,SaveMovie,LowThresholdValue,HighThresholdValue,MovieNum);
          set(HandlesForGUIControls.StatusText,'string','Finished analyzing');
          if SaveResultsWhenAnalysisFinished==1
             filenameOfSettings=[filenameBehavioralForAnalysis(1:end-4) '_video_data_results' num2str(MovieNum) '.mat'];
             save(filenameOfSettings,'filenameBehavioralForAnalysis','StartingFrameForAnalysisNum','EndingFrameForAnalysisNum','LastFrameAnalyzed','ExcludedAreasList','CompartmentsPositionsList','StimuliPositionsList',...
        ...
        case 'WhiteRatWiredHeadDirectBased13_1_2019_Fast'
          [MouseLocationCenterOfBody,TimesOfStimuliExploration,TimesInDifferentCompartments,firstFrameInTheAnalysis,LastFrameAnalyzed]=...
          WhiteRatWiredHeadDirectBased13_1_2019_Fast(filenameBehavioralForAnalysis,HandlesForGUIControls,StartingFrameForAnalysisNum,EndingFrameForAnalysisNum,ExcludedAreasList,CompartmentsPositionsList,StimuliPositionsList,SaveMovie,LowThresholdValue,HighThresholdValue,MovieNum);
          set(HandlesForGUIControls.StatusText,'string','Finished analyzing');
          if SaveResultsWhenAnalysisFinished==1
             filenameOfSettings=[filenameBehavioralForAnalysis(1:end-4) '_video_data_results' num2str(MovieNum) '.mat'];
             save(filenameOfSettings,'filenameBehavioralForAnalysis','StartingFrameForAnalysisNum','EndingFrameForAnalysisNum','LastFrameAnalyzed','ExcludedAreasList','CompartmentsPositionsList','StimuliPositionsList',...
        ...
        case 'TwoWhiteMiceWiredBodyBased23_7_19'
          [TimesOfTwoMiceInteraction, MouseLocationCenterOfBody1, MouseLocationCenterOfBody2, firstFrameInTheAnalysis,LastFrameAnalyzed]=TwoWhiteMiceWiredBodyBased23_7_19(filenameBehavioralForAnalysis,HandlesForGUIControls,StartingFrameForAnalysisNum,EndingFrameForAnalysisNum,ExcludedAreasList,SaveMovie,LowThresholdValue,MovieNum);
          set(HandlesForGUIControls.StatusText,'string','Finished analyzing');
          if SaveResultsWhenAnalysisFinished==1
             filenameOfSettings=[filenameBehavioralForAnalysis(1:end-4) '_video_data_results' num2str(MovieNum) '.mat'];
             save(filenameOfSettings,'filenameBehavioralForAnalysis','StartingFrameForAnalysisNum','EndingFrameForAnalysisNum','LastFrameAnalyzed','ExcludedAreasList','CompartmentsPositionsList','StimuliPositionsList',...
        ...
        case 'TwoWhiteMiceWiredBodyBased23_7_19_Fast'
          [TimesOfTwoMiceInteraction, MouseLocationCenterOfBody1, MouseLocationCenterOfBody2, firstFrameInTheAnalysis,LastFrameAnalyzed]=TwoWhiteMiceWiredBodyBased23_7_19_Fast(filenameBehavioralForAnalysis,HandlesForGUIControls,StartingFrameForAnalysisNum,EndingFrameForAnalysisNum,ExcludedAreasList,SaveMovie,LowThresholdValue,MovieNum);
          set(HandlesForGUIControls.StatusText,'string','Finished analyzing');
          if SaveResultsWhenAnalysisFinished==1
             filenameOfSettings=[filenameBehavioralForAnalysis(1:end-4) '_video_data_results' num2str(MovieNum) '.mat'];
             save(filenameOfSettings,'filenameBehavioralForAnalysis','StartingFrameForAnalysisNum','EndingFrameForAnalysisNum','LastFrameAnalyzed','ExcludedAreasList','CompartmentsPositionsList','StimuliPositionsList',...
...
try
   FrameRateForAnalysis=FrameRateForAnalysisAllFiles(CurrentFileAnalyzed,:);
catch
   %%% Do nothing 
end
...
function FrameRateForAnalysisEdit_Callback(hObject, eventdata, handles)
% hObject    handle to FrameRateForAnalysisEdit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of FrameRateForAnalysisEdit as text
%        str2double(get(hObject,'String')) returns contents of FrameRateForAnalysisEdit as a double
...
nFrames = floor(Film.Duration*Film.FrameRate); 
clear Film;
EndingFrameForAnalysisNumAllFiles(CurrentFileAnalyzed)=nFrames;
set(HandlesForGUIControls.EndingFrameForAnalysisEdit,'string',num2str(EndingFrameForAnalysisNumAllFiles(CurrentFileAnalyzed)));

% --- Executes during object creation, after setting all properties.
function FrameRateForAnalysisEdit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to FrameRateForAnalysisEdit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
